...
class Settigs(Menu):
    def __init__(self, size):
        ...
        self.add_button(text="⬅️ Back", callback_data="back")
        self.get_size()


class SettigsRu(Menu):
    def __init__(self, size):
        super().__init__(lang="ru_set", size=size)
        self.add_button(text="Подписаться", callback_data="sub")
